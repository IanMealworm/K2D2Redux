...
using K2D2; // FIXED during Redux port verification: FunctionQueue/FunctionObject live in namespace K2D2
            // (CustomQueue.cs), and this file used them with no using for that namespace at all - a plain
            // compile error, unrelated to the Redux API surface, likely a leftover from restructuring
            // folders during the port.
